...
<table width="635" border="0" cellspacing="2" style="margin:0px 0" class="ranking"> 
  ...
  <?php
  $i = 1;
 $sql = $conexao->prepare("SELECT *,(SELECT name FROM clan_subpledges WHERE c.clanid = clan_id) AS clan from characters AS c where accesslevel = '0' order by pkkills DESC LIMIT 25");
