...
tag php + echo + nome da define. Coloque esta linha onde achar conveniente.
<?php echo nomeDaDefine; ?>

*/

//Links Download System
define ('mega','https://mega.co.nz');//DOWNLOAD VIA MEGA.
define ('mediafire','https://mediafire.com');//DOWNLOAD VIA MEDIAFIRE.

//Links Download Animations
define ('mega2','https://mega.co.nz');//DOWNLOAD VIA MEGA.
define ('mediafire2','https://mediafire.com');//DOWNLOAD VIA MEDIAFIRE.

//Links Download Systextures
define ('mega3','https://mega.co.nz');//DOWNLOAD VIA MEGA.
define ('mediafire3','https://mediafire.com');//DOWNLOAD VIA MEDIAFIRE.

//Links Download Patch Full .exe
define ('mega4','https://mega.co.nz');//DOWNLOAD VIA MEGA.
define ('mediafire4','https://mediafire.com');//DOWNLOAD VIA MEDIAFIRE.

//Links Download Patch Full .rar
define ('mega5','https://mega.co.nz');//DOWNLOAD VIA MEGA.
define ('mediafire5','https://mediafire.com');//DOWNLOAD VIA MEDIAFIRE.

//Links Download Cliente Interlude
define ('mega6','https://mega.co.nz');//DOWNLOAD VIA MEGA.
...
define ('drop', '3');//DEFINE DROP NA BARRA DO TOPO.
